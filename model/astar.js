function PathfindingAStar(blockOfCubes, startPoint, endPoint) {
    /**
     * NOTE: Classical A-Star pathfinder algorithm, with 3 DOF movement (up/down, left/right, forward/backward), each
     * movement has a cost of 1 weight.
     * The heuristic distance is calculated using Manhattan distance.
     * 
