function PathfindingEuclideanHP_AStar(blockOfCubes, startPoint, endPoint) {
  /**
     * NOTE: the Euclidean distance heuristic penalized A-Star uses the Euclidean distance to calculate the heuristics.
     * 
     * This algorithm behaves similarly to the A* algorithm with Manhattan distance calculation.
     * 
